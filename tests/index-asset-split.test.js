...
assert.match(html, /assets\/styles\/pages\.css\?v=20260716-duration-text-v1/, 'index.html should bust stale cached pages.css after schedule duration text style fixes');

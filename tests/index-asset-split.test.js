...
assert.match(html, /assets\/styles\/pages\.css\?v=20260716-coach-mask-freeze-v4/, 'index.html should bust stale cached pages.css after coach schedule mask and freeze fixes');
...
assert.match(html, /assets\/scripts\/pages\/coachops\.js\?v=20260716-coach-mask-freeze-v4/, 'index.html should version coachops.js after coach schedule mask and freeze fixes');

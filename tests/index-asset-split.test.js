...
assert.match(html, /assets\/styles\/pages\.css\?v=20260716-coach-month-fluid-v1/, 'index.html should bust stale cached pages.css after coach schedule month fluid layout fixes');
...
assert.match(html, /assets\/scripts\/pages\/coachops\.js\?v=20260716-coach-month-fluid-v1/, 'index.html should version coachops.js after coach schedule month fluid layout fixes');

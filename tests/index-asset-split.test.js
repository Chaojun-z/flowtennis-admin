...
assert.match(html, /assets\/styles\/pages\.css\?v=20260715-coach-canvas-sticky-v2/, 'index.html should bust stale cached pages.css after coach schedule sticky canvas fixes');
...
assert.match(html, /assets\/scripts\/pages\/coachops\.js\?v=20260715-coach-canvas-sticky-v2/, 'index.html should version coachops.js after coach schedule sticky canvas fixes');

...
assert.match(html, /assets\/styles\/pages\.css\?v=20260716-coach-top-guard-v5/, 'index.html should bust stale cached pages.css after coach schedule top guard fixes');
...
assert.match(html, /assets\/scripts\/pages\/coachops\.js\?v=20260716-coach-top-guard-v5/, 'index.html should version coachops.js after coach schedule top guard fixes');

...
assert.match(html, /assets\/scripts\/pages\/schedule\.js\?v=20260830-schedule-student-settlement-v2/, 'index.html should bust stale cached schedule.js after student settlement fixes');

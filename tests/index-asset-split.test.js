...
assert.match(html, /assets\/styles\/pages\.css\?v=20260802-course-colors-coachschedule-v1/, 'index.html should bust stale cached pages.css after coach calendar current-time alignment fix');
...
assert.match(html, /assets\/scripts\/pages\/leads\.js\?v=20260807-leads-server-pagination-v1/, 'index.html should bust stale cached leads.js after lead server pagination changes');

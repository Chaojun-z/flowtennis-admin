...
assert.match(html, /assets\/styles\/pages\.css\?v=20260911-active-students-actions-hidden-v2/, 'index.html should bust stale cached pages.css after active-student toolbar visibility fixes');
...
assert.match(html, /assets\/scripts\/core\/bootstrap\.js\?v=20260911-active-students-actions-hidden-v2/, 'index.html should bust stale cached bootstrap.js after active-student toolbar visibility fixes');
...
assert.match(html, /assets\/scripts\/pages\/students\.js\?v=20260907-student-drawer-summary-v4/, 'index.html should bust stale cached students.js after student lesson fact guard fixes');
...
assert.match(html, /assets\/scripts\/pages\/schedule-settlement\.js\?v=20260831-per-student-settlement-block-v1[\s\S]*assets\/scripts\/pages\/schedule\.js\?v=20260909-single-small-student-entitlement-v1/, 'index.html should keep current schedule asset ordering and versions');

...
assert.match(html, /assets\/styles\/pages\.css\?v=20260715-coachschedule-fluid-v1/, 'index.html should bust stale cached pages.css after coach schedule fluid layout fixes');
...
assert.match(html, /assets\/scripts\/pages\/coachops\.js\?v=20260715-coachschedule-fluid-v1/, 'index.html should version coachops.js after coach schedule fluid layout fixes');

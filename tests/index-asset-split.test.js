...
assert.match(html, /assets\/styles\/pages\.css\?v=20260719-coach-month-popover-v2/, 'index.html should bust stale cached pages.css after coach month popover adaptive width fixes');
...
assert.match(html, /assets\/scripts\/pages\/coachops\.js\?v=20260719-coach-month-popover-v2/, 'index.html should version coachops.js after coach month popover adaptive width fixes');

...
assert.match(html, /assets\/styles\/pages\.css\?v=20260719-coach-month-popover-v1/, 'index.html should bust stale cached pages.css after coach month popover fixes');
...
assert.match(html, /assets\/scripts\/pages\/coachops\.js\?v=20260719-coach-month-popover-v1/, 'index.html should version coachops.js after coach month popover fixes');

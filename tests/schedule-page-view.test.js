...
assert.match(indexHtml, /state\.js\?v=20260908-trial-summary-repair-v2/, 'state script version should force a fresh browser load for teaching summary repair handling fixes');

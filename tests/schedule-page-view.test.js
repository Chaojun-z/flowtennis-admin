...
assert.match(indexHtml, /state\.js\?v=20260808-leads-stats-skeleton-v1/, 'state script version should force a fresh browser load for latest page data changes');

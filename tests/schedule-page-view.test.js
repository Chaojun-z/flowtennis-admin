...
assert.match(source, /shilipu[\s\S]*5号场/, 'shared campus venue rules should expose five fixed venues for 十里堡');
assert.match(source, /guowang[\s\S]*mode:'text'/, 'shared campus venue rules should allow free-form court input for 国网');

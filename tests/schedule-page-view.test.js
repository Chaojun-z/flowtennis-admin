...
assert.match(indexHtml, /state\.js\?v=20260807-leads-server-pagination-v1/, 'state script version should force a fresh browser load for latest page data changes');

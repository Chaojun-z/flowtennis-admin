...
assert.match(indexHtml, /state\.js\?v=20260802-course-colors-coachschedule-v1/, 'state script version should force a fresh browser load for renderer recovery');

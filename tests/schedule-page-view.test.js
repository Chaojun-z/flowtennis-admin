...
assert.match(indexHtml, /state\.js\?v=20260806-purchase-stale-cache-v1/, 'state script version should force a fresh browser load for purchase stale-cache recovery');

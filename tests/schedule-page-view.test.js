...
assert.match(indexHtml, /state\.js\?v=20260908-teaching-summary-repair-v1/, 'state script version should force a fresh browser load for teaching summary repair handling fixes');

...
const routesPath = path.join(repoRoot, 'api/page-data/core-pages.js');

assert.ok(fs.existsSync(routesPath), 'api/page-data/core-pages.js should own core page-data read routes');

const routesSource = fs.readFileSync(routesPath, 'utf8');

assert.match(apiSource, /require\('\.\/page-data\/core-pages\.js'\)/, 'api/index.js should import core page-data routes');

...
assert.match(fnBody('renderMembershipStats'), /const financeSummary=courtAccountListViewData\?\.summary\?\.membershipFinanceSummary\|\|\{\};[\s\S]*financeSummary\.paidAmount[\s\S]*financeSummary\.consumableAmount[\s\S]*financeSummary\.consumedAmount[\s\S]*financeSummary\.pendingAmount/, 'membership summary should display the unified court account read-model membership finance summary');

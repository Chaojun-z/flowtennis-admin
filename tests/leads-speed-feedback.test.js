...
assert.match(html, /assets\/scripts\/core\/bootstrap\.js\?v=20260911-active-students-actions-hidden-v2/, 'index should keep the current bootstrap script asset version');

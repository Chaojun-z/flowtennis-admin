...
assert.match(cssRule('.package-audience-badge'), /height:17px/, 'audience badge should replace the time band badge in the title row');
assert.match(packageBoardCardHtml, /packageAudienceBadgeHtml\(p\)/, 'package card should render adult/youth in the title row');
...
assert.match(cssRule('.package-sales-title-row'), /align-items:center/, 'title, audience badge and sale status row should be vertically centered');

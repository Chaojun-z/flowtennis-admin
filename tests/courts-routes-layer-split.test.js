...
const routesPath = path.join(repoRoot, 'api/courts-routes.js');

assert.ok(fs.existsSync(routesPath), 'api/courts-routes.js should own court write/import/merge routes');

const routesSource = fs.readFileSync(routesPath, 'utf8');

assert.match(apiSource, /require\('\.\/courts-routes'\)/, 'api/index.js should import court routes from api/courts-routes.js');

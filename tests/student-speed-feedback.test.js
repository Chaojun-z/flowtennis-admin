...
assert.match(html, /assets\/scripts\/core\/bootstrap\.js\?v=20260807-student-speed-feedback-v1/, 'index should bust stale cached bootstrap.js after student speed feedback fixes');

...
assert.match(standardSource, /微信名[\s\S]*线索时间[\s\S]*来源[\s\S]*类型[\s\S]*需求产品[\s\S]*水平[\s\S]*基本信息[\s\S]*线索阶段[\s\S]*跟进优先级[\s\S]*跟进人[\s\S]*体验课时间[\s\S]*成交教练[\s\S]*流失原因[\s\S]*操作/, 'leads table should expose the requested reordered columns');

...
assert.match(fnBody('runLeadImportCommit'), /refreshLeadRuntime\(\{withStudents:true,withCourts:true,waitForMetrics:false\}\)/, 'lead import should refresh local rows without waiting for lifecycle metrics');
assert.match(fnBody('runLeadImportCommit'), /refreshLeadRuntimeInBackground\(\{\},renderLeads\)/, 'lead import should refresh lifecycle metrics in the background after local rows render');

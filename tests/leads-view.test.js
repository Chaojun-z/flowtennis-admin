...
assert.match(standardSource, /微信名[\s\S]*线索时间[\s\S]*线索渠道[\s\S]*咨询需求[\s\S]*水平[\s\S]*基本信息[\s\S]*跟进人[\s\S]*体验课时间[\s\S]*线索阶段[\s\S]*转化教练[\s\S]*未转化原因[\s\S]*操作/, 'leads table should expose the requested reordered columns');

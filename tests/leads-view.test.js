...
assert.match(leadsSource, /async function refreshLeadRuntime\([\s\S]*\['leads','lifecycleMetricsPage'\]/, 'lead mutations should refresh the unified backend metrics together with the lead rows');

...
assert.match(residualPageDataSource, /const forceFresh=query\?\.get\('fresh'\)==='1'\|\|query\?\.get\('forceFresh'\)==='1';[\s\S]*loadCourtAccountListView\(\{sampleIds:ids,sample,forceFresh,includeDetails:ids\.length>0\}\)/, 'court account read model should support fresh reads after membership benefit mutations');

...
assert.match(pagesCss, /body\.admin-mobile #page-leads \.tms-filters,body\.admin-mobile #page-students \.tms-filters\{[^}]*position:absolute[^}]*top:calc\(100% \+ 8px\)[^}]*width:min\(270px,calc\(100vw - 32px\)\)/, 'lead and student H5 filters should open as a compact dropdown below the filter icon');

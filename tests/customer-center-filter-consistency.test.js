...
assert.ok(
  leadsRouteSource.includes('readReadyStudentTeachingSummaryListRows({tableName:T_STUDENT_TEACHING_SUMMARY,getCachedRow,verifyChecksum:true})'),
  '线索池顶部学员指标必须读取 ready activeVersion 轻量列表包，不能命中旧热缓存或扫描版本行'
);
assert.ok(

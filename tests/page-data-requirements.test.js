...
assert.doesNotMatch(coachScheduleRouteSource, /T_PURCHASES|T_ENTITLEMENTS|T_ENTITLEMENT_LEDGER|buildStandardLifecycleMetrics|buildWorkbenchStats/, 'coach schedule endpoint must not scan heavy package or workbench-only facts');

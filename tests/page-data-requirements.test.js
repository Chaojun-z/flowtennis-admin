...
assert.match(corePagesSource, /const needsTeachingFacts = fresh[\s\S]*teachingLessonDetailSourceVersion[\s\S]*!== TEACHING_LESSON_DETAIL_SOURCE_VERSION/, 'customer center list endpoint should fall back to live lesson facts when teaching summaries use the old lesson-record口径');

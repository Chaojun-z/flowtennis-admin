...
assert.match(source, /packages:\['purchasesPage','products','packageBoardPreferences'\]/, 'packages page should wait for its aggregated package-sale dependencies so the empty state is stable');

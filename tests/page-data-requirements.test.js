...
assert.match(source, /const STUDENT_DETAIL_REQUIREMENTS=\['entitlements','entitlementLedger','feedbacks','products','purchasesPage','membershipBenefitLedger'\];/, 'student detail should lazy-load package consume ledger, purchase amount data, and student benefits');

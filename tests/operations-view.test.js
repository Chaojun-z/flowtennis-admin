...
assert.match(componentsSource, /setOperationsTab\('conversion'\);goPage\('operations',this\)[\s\S]*转化与留存/, 'sidebar should expose conversion as a left menu item');
...
assert.match(componentsSource, /data-nav-page="operations" data-operations-tab="overview"/, 'operations overview menu item should carry a distinct tab key');
assert.match(componentsSource, /data-nav-page="operations" data-operations-tab="conversion"/, 'operations conversion menu item should carry a distinct tab key');
...
assert.match(bootstrapSource, /OPERATIONS_TITLE_MAP=\{overview:'经营总览',court:'场地运转',conversion:'转化与留存',coach:'教练人效'\}/, 'operations page title should use the selected subpage, not the module name');

...
assert.match(chartsSource, /buildOperationsCoachMatrixChartOption[\s\S]*grid: \{ left: 4, right: 4, top: 4, bottom: 6, containLabel: true \}[\s\S]*axisLabel: \{ formatter: value => operationsCoachRevenueAxisLabel\(value\), color: '#A19080', fontSize: 11, margin: 4, verticalAlign: 'top' \}/, 'coach matrix should keep corner labels inside while reclaiming chart area');
assert.match(chartsSource, /buildOperationsCoachCapabilityChartOption[\s\S]*grid: \{ left: 4, right: 4, top: 4, bottom: 6, containLabel: true \}[\s\S]*yAxis: \{ type: 'value'[\s\S]*axisLabel: \{ formatter: '\{value\}%', color: '#A19080', fontSize: 11, margin: 4, verticalAlign: 'top' \}/, 'coach capability matrix should keep corner labels inside while reclaiming chart area');
...
assert.match(chartsSource, /buildOperationsCoachParetoChartOption[\s\S]*grid: \{ left: 40, right: 30, top: 14, bottom: 30, containLabel: true \}/, 'coach contribution chart should reduce side and bottom whitespace without clipping labels');

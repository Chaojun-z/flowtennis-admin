...
assert.match(chartsSource, /function operationsCoachCourseColor[\s\S]*if \(type === '体验课'\) return '#D97706'[\s\S]*if \(type === '私教课'\) return '#0F766E'[\s\S]*if \(type === '小班课'\) return '#E7E5E4'/, 'coach course mix should use the Gemini course colors');

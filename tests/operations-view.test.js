...
assert.match(chartsSource, /operationsCoachQuadrantColors[\s\S]*q1: '#B58B4C'[\s\S]*q2: '#6B8E9B'[\s\S]*q3: '#A75D5D'[\s\S]*q4: '#7C8B6F'/, 'coach matrices should use the Gemini quadrant color palette');
...
assert.match(chartsSource, /function operationsCoachQuadrantColor\(x = 0, y = 0, xMid = 50, yMid = 50\)[\s\S]*operationsCoachQuadrantColors\.q1[\s\S]*operationsCoachQuadrantColors\.q2[\s\S]*operationsCoachQuadrantColors\.q3[\s\S]*operationsCoachQuadrantColors\.q4/, 'coach matrix point colors should follow the Gemini quadrant they land in');
...
assert.match(chartsSource, /const operationsCoachAxisLabel = \{[\s\S]*fontFamily: 'var\(--ops-number-font\)'[\s\S]*fontSize: 11/, 'coach chart axis labels should share the numeric font style');

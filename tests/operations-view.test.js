...
assert.match(operationsSource, /operationsConversionFilterViewKey[\s\S]*source:[\s\S]*campus:[\s\S]*coach:/, 'conversion page should resolve filtered views by a stable backend view key');
assert.match(operationsSource, /data\.conversion\?\.filteredViews\?\.\[operationsConversionFilterViewKey\(\)\]/, 'conversion page should read filtered conversion metrics from the backend view model');

...
assert.match(fnBody('studentLessonRecordHtml'), /const title=\[studentSequenceText&&studentSequenceText!==sectionText\?studentSequenceText:'',sectionText,item\.lessonRelationText,detailText\]\.filter\(Boolean\)\.join\(' '\)/, 'authorized package lesson records should show the student sequence, package section, and package relation in the drawer');
...
assert.match(fnBody('studentLessonRecordHtml'), /studentLessonSequenceText[\s\S]*studentSequenceText!==sectionText[\s\S]*sectionText/, 'student lesson record title should show the continuous student lesson sequence before package section text');

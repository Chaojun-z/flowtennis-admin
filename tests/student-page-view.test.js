...
assert.match(html, /function renderStudentToolbarFilters\(/, 'student filters should render through the booking-style dropdown helper');
assert.match(html, /stuTypeFilterHost[\s\S]*onStudentFilterChange/, 'student type filter should reset pagination before rendering');
assert.match(html, /stuSourceFilterHost[\s\S]*onStudentFilterChange/, 'student source filter should reset pagination before rendering');
assert.match(html, /stuLinkFilterHost[\s\S]*onStudentFilterChange/, 'student relation filter should reset pagination before rendering');
...
assert.match(html, /stuLinkFilterHost/, 'student page should include relation filter host');
...
assert.match(html, /openStudentDetail\('[^']+'\)[\s\S]*openStudentModal\('[^']+'\)/, 'student row should prioritize view before edit');

...
assert.match(source, /function studentLessonRecordDetailSectionText\([\s\S]*if\(row\.lessonSectionText\)return row\.lessonSectionText;[\s\S]*String\(item\.entitlementId\|\|item\.purchaseId\|\|item\.packageName\|\|''\)\.trim\(\)===entitlementId[\s\S]*return `\[第\$\{startText\}/, 'backend unified student lesson detail rows should show current package section numbers for historical rows');

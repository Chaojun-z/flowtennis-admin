...
assert.match(fnBody('studentLessonRecordTitleText'), /studentLessonSequenceText[\s\S]*className\|\|item\.packageName\|\|item\.courseDisplayName\|\|item\.courseType[\s\S]*studentSequenceText\|\|fallbackSection/, 'student lesson record title should show the continuous student lesson sequence with the package or course name');

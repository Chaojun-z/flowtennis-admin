...
assert.match(workbenchRouteSource, /readReadyStudentTeachingSummaryListRows\(\{tableName:T_STUDENT_TEACHING_SUMMARY,getCachedRow,getCachedScan,scanByIdPrefix,verifyChecksum:true\}\)/, 'workbench API should read the ready summary list and use summary-table light-field fallback before returning empty data');

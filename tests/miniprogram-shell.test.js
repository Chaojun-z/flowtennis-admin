...
assert.match(workbenchRouteSource, /readReadyStudentTeachingSummaryListRows\(\{tableName:T_STUDENT_TEACHING_SUMMARY,getCachedRow,verifyChecksum:true\}\)/, 'workbench API should read only the ready active-version list bundle for mini program student details');

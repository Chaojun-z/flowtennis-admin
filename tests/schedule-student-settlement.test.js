...
assert.match(indexHtml, /schedule-settlement\.js\?v=20260831-per-student-settlement-block-v1[\s\S]*schedule\.js\?v=20260913-student-teaching-summary-delta-v1/, 'settlement helper should load before schedule.js');

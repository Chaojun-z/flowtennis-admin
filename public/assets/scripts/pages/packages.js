...
function packageTimeBandBadgeHtml(p={}){
  ...
  return `<span class="package-time-band-badge ${packageTimeBandBadgeClass(label)}">${esc(label)}</span>`;
}

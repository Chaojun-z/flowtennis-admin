...
function renderFinanceOverview(){
  ...
  const storedValueAccountTotal=overview&&overview.storedValueAccountTotal!==undefined?Number(overview.storedValueAccountTotal||0):storedValueIncome;
  ...
  primaryHost.innerHTML=renderStatCards([
    ...
    {label:'会员收入 / 已入账',value:financeCardValue(storedValueAccountTotal,finalStoredValueRecognized),split:true},

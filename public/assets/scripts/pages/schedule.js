...
function refreshScheduleDeductionLabel(){
  ...
  if(label)label.textContent=normalizeCourseType(document.getElementById('sch_courseType')?.value||'')==='小班课'?'消耗次数':'消课节数';
}

...
function studentUnifiedViewRows(){
  ...
  return baseRows.map(row=>{
    ...
    return {
      ...
      status:Object.prototype.hasOwnProperty.call(student,'status')?student.status:row.status,
      mergedIntoStudentId:Object.prototype.hasOwnProperty.call(student,'mergedIntoStudentId')?student.mergedIntoStudentId:row.mergedIntoStudentId,
      deletedAt:Object.prototype.hasOwnProperty.call(student,'deletedAt')?student.deletedAt:row.deletedAt,
      archivedAt:Object.prototype.hasOwnProperty.call(student,'archivedAt')?student.archivedAt:row.archivedAt,
...
const STUDENT_PACKAGE_STATUS_OPTIONS=['未买过课包','课包有余额','课包即将耗尽','课包已用完','使用他人课包'];
...
function studentLabelTagClass(value){
  ...
  return ({
    ...
    '使用他人课包':'tms-tag-business-type-adult',

...
function standardListPageShellConfigs(){
  return [
    ...
    {key:'schedule',toolbar:{search:{id:'schSearch',oninput:'onScheduleFilterChange()'},filterHostIds:['schCourseTypeFilterHost','schCoachFilterHost','schProposalFilterHost','schFeedbackFilterHost','schStatusFilterHost'],actionsHtml:'<button class="tms-btn tms-btn-primary" onclick="openScheduleModal(null)">添加排课</button>'},table:{bodyId:'schTbody',pager:{infoId:'schPagerInfo',pageSizeId:'schPageSize',buttonsId:'schPagerBtns',pageSizeTag:'span'},columns:[{label:'日期',className:'tms-sticky-l',style:'width:84px;padding-left:14px'},{label:'上课时间',style:'width:92px'},{label:'时长',style:'width:52px'},{label:'校区/场地',style:'width:125px'},{label:'教练',style:'width:68px'},{label:'学员',style:'width:120px'},{label:'课程类型',style:'width:100px'},{label:'课前教案',style:'width:72px'},{label:'课后反馈',style:'width:72px'},{label:'重复?',style:'width:64px'},{label:'状态',style:'width:68px'},{label:'操作',className:'tms-sticky-r',style:'width:118px;padding-right:10px;text-align:right'}]}},

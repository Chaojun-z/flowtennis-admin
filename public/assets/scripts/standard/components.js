...
function standardListPageShellConfigs(){
  return [
    ...
    {key:'purchases',toolbar:{search:{id:'purSearch',oninput:'onPurchaseSearchChange()'},filterHostIds:['purCourseTypeFilterHost','purInPeriodFilterHost','purPayStatusFilterHost'],actionsHtml:'<button class="tms-btn tms-btn-primary" onclick="openPurchaseEntryModal()">课包购买</button>'},table:{bodyId:'purchaseTbody',pager:{infoId:'purPagerInfo',pageSizeId:'purPageSize',buttonsId:'purPagerBtns'},columns:[{label:'姓名',style:'width:110px;padding-left:20px'},{label:'课程类型',style:'width:110px'},{label:'用户类型',style:'width:74px'},{label:'上课人数',style:'width:86px'},{label:'在期状态',style:'width:108px'},{label:'付费状态',style:'width:74px'},{label:'报名时间',style:'width:100px'},{label:'报名课时',style:'width:74px'},{label:'报名费用',style:'width:84px'},{label:'归属教练',style:'width:90px'},{label:'赠送课时',style:'width:74px'},{label:'课包余额',style:'width:92px'},{label:'操作',className:'tms-sticky-r',style:'width:108px;padding-right:20px;text-align:right'}]},afterHtml:'<div id="purchaseMobileCards" class="admin-h5-card-list"></div>'},

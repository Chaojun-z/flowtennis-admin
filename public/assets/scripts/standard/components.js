...
function standardListPageShellConfigs(){
  return [
    ...
    {key:'classes',statsId:'classStatsRow',noteHtml:'班次用于组织固定上课关系和学习进度；是否还能继续约课，仍然以课包余额和可用规则为准。',toolbar:{search:{id:'clsSearch',oninput:'renderClasses()'},filterHostIds:['clsStatusFilterHost','clsCampusFilterHost','clsCoachFilterHost','clsTypeFilterHost'],actionsHtml:'<button class="tms-btn tms-btn-primary" onclick="openClassModal(null)">新建班次</button>'},table:{bodyId:'clsTbody',pager:{infoId:'clsPagerInfo',buttonsId:'clsPagerBtns'},columns:[{label:'班次名称',style:'width:220px;padding-left:20px'},{label:'班次编号',style:'width:130px'},{label:'课程',style:'width:150px'},{label:'类型',style:'width:110px'},{label:'开始日期',style:'width:120px'},{label:'结束日期',style:'width:120px'},{label:'校区',style:'width:100px'},{label:'学员',style:'width:180px'},{label:'教练',style:'width:100px'},{label:'上课日',style:'width:100px'},{label:'最近上课',style:'width:120px'},{label:'下次课',style:'width:120px'},{label:'课时进度',style:'width:130px'},{label:'状态',style:'width:100px'},{label:'操作',className:'tms-sticky-r',style:'width:160px;padding-right:20px;text-align:right'}]}},
    {key:'plans',noteHtml:'学习计划由「班次管理」自动生成，每个学员 × 班次 = 一条记录；班次进度用于看学习推进，真实可约课以课包余额规则为准。',toolbar:{search:{id:'planSearch',oninput:'renderPlans()'},filterHostIds:['planStatusFilterHost','planCampusFilterHost','planCoachFilterHost','planTypeFilterHost','planStageFilterHost']},table:{bodyId:'planTbody',pager:{infoId:'planPagerInfo',buttonsId:'planPagerBtns'},columns:[{label:'学员',style:'width:140px;padding-left:20px'},{label:'手机号',style:'width:140px'},{label:'班次',style:'width:180px'},{label:'课程',style:'width:150px'},{label:'教练',style:'width:110px'},{label:'最近上课',style:'width:120px'},{label:'班次进度',style:'width:140px'},{label:'课包余额',style:'width:240px'},{label:'状态',style:'width:100px'},{label:'操作',className:'tms-sticky-r',style:'width:180px;padding-right:20px;text-align:right'}]}},
    ...
    {key:'campusmgr',toolbar:{search:{id:'campusSearch',oninput:'renderCampuses()'},actionsHtml:'<button class="tms-btn tms-btn-primary" onclick="openCampusModal(null)">新增校区</button>'},table:{bodyId:'campusTbody',columns:[{label:'校区名称',style:'width:34%;padding-left:20px'},{label:'校区代码',style:'width:24%'},{label:'创建时间',style:'width:22%'},{label:'操作',className:'tms-sticky-r',style:'width:132px;padding-right:20px;text-align:right'}]}},

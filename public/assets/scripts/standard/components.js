...
function standardListPageShellConfigs(){
  return [
    ...
    {key:'purchases',toolbar:{search:{id:'purSearch',oninput:'onPurchaseFilterChange()'},filterHostIds:['purPackageFilterHost'],actionsHtml:'<button class="tms-btn tms-btn-primary" onclick="openPurchaseEntryModal()">课包购买</button>'},table:{bodyId:'purchaseTbody',pager:{infoId:'purPagerInfo',pageSizeId:'purPageSize',buttonsId:'purPagerBtns'},columns:[{label:'支付日期',style:'width:100px;padding-left:20px'},{label:'姓名',style:'width:80px'},{label:'课包',style:'width:260px'},{label:'应收',style:'width:70px'},{label:'实收',style:'width:70px'},{label:'差价',style:'width:70px'},{label:'余额',style:'width:80px'},{label:'状态',style:'width:64px'},{label:'归属教练',style:'width:78px'},{label:'支付方式',style:'width:78px'},{label:'操作',className:'tms-sticky-r',style:'width:120px;padding-right:20px;text-align:right'}]},afterHtml:'<div id="purchaseMobileCards" class="admin-h5-card-list"></div>'},

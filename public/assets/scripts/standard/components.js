...
function standardListPageShellConfigs(){
  return [
    ...
    {key:'matches',statsId:'matchStatsRow',toolbar:{search:{id:'matchSearch',oninput:'renderMatches()'},filterHostIds:['matchStatusFilterHost'],actionsHtml:'<button class="tms-btn tms-btn-ghost" onclick="loadMatches(true)">刷新</button>'},table:{bodyId:'matchTbody',columns:[{label:'球局',style:'width:220px;padding-left:20px'},{label:'时间',style:'width:150px'},{label:'场地',style:'width:160px'},{label:'人数',style:'width:90px'},{label:'状态',style:'width:100px'},{label:'预计费用',style:'width:120px'},{label:'最终费用',style:'width:120px'},{label:'报名名单',style:'width:240px'},{label:'操作',className:'tms-sticky-r',style:'width:220px;padding-right:20px;text-align:right'}]},afterHtml:'<div id="matchMobileCards" class="admin-h5-card-list"></div>'},

...
function standardListPageShellConfigs(){
  return [
    ...
    {key:'students',statsId:'studentStatsRow',toolbar:{search:{id:'stuSearch',oninput:'onStudentFilterChange()'},filterHostIds:['stuTypeFilterHost','stuSourceFilterHost','stuPackageStatusFilterHost','stuPaymentModeFilterHost','stuActivityStatusFilterHost','stuLessonVolumeFilterHost','stuLifecycleStatusFilterHost','stuCoachFilterHost'],actionsHtml:'<span class="tms-export-action" onclick="exportStudentCSV()">导出</span><button class="tms-btn tms-btn-primary" onclick="openStudentModal(null)">添加学员</button>'},table:{bodyId:'stuTbody',pager:{infoId:'stuPagerInfo',pageSizeId:'stuPageSize',buttonsId:'stuPagerBtns'},columns:[{label:'姓名',className:'tms-sticky-l',style:'width:130px;padding-left:20px'},{label:'来源',style:'width:110px'},{label:'类型',style:'width:90px'},{label:'校区',style:'width:105px'},{label:'活跃状态',style:'width:120px'},{label:'付费方式',style:'width:120px'},{label:'课包状态',style:'width:120px'},{label:'历史课时',style:'width:110px'},{label:'学员状态',style:'width:120px'},{label:'负责教练',style:'width:110px'},{label:'备注',style:'width:280px'},{label:'操作',className:'tms-sticky-r',style:'width:150px;padding-right:20px;text-align:right'}]},afterHtml:'<div id="studentMobileCards" class="admin-h5-card-list"></div>'},

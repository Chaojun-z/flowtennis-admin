...
function standardListPageShellConfigs(){
  return [
    ...
    {key:'students',statsId:'studentStatsRow',toolbar:{search:{id:'stuSearch',oninput:'onStudentFilterChange()'},filterHostIds:['stuTypeFilterHost','stuSourceFilterHost','stuTrialStatusFilterHost','stuDealPathFilterHost','stuCoachFilterHost'],actionsHtml:'<span class="tms-export-action" onclick="exportStudentCSV()">导出</span><button class="tms-btn tms-btn-primary" onclick="openStudentModal(null)">添加学员</button>'},table:{bodyId:'stuTbody',pager:{infoId:'stuPagerInfo',pageSizeId:'stuPageSize',buttonsId:'stuPagerBtns'},columns:[{label:'姓名',className:'tms-sticky-l',style:'width:130px;padding-left:20px'},{label:'来源',style:'width:110px'},{label:'类型',style:'width:90px'},{label:'校区',style:'width:105px'},{label:'成交路径',style:'width:100px'},{style:'width:110px',html:'<button class="tms-sort-header" data-student-sort="packagePurchaseDate" onclick="cycleStudentSort(\'packagePurchaseDate\')">课包购买时间<span class="tms-sort-icon"><span class="tms-sort-up"></span><span class="tms-sort-down"></span></span></button>'},{label:'课包',style:'width:260px'},{label:'负责教练',style:'width:110px'},{style:'width:90px',html:'<button class="tms-sort-header" data-student-sort="packageLessons" onclick="cycleStudentSort(\'packageLessons\')">课包余额<span class="tms-sort-icon"><span class="tms-sort-up"></span><span class="tms-sort-down"></span></span></button>'},{style:'width:100px',html:'<button class="tms-sort-header" data-student-sort="completedLessons" onclick="cycleStudentSort(\'completedLessons\')">累计上课<span class="tms-sort-icon"><span class="tms-sort-up"></span><span class="tms-sort-down"></span></span></button>'},{label:'备注',style:'width:280px'},{label:'操作',className:'tms-sticky-r',style:'width:150px;padding-right:20px;text-align:right'}]},afterHtml:'<div id="studentMobileCards" class="admin-h5-card-list"></div>'},

...
let courtSortKey='',courtSortDir='desc',stuSortKey='',stuSortDir='',courtOwnerFilterValue='',courtAccountTypeFilterValue='',leadPageSize=20,stuPageSize=20,courtPageSize=20,financeLedgerPageSize=20,selectedCourtIds=new Set(),courtBatchMode=false;

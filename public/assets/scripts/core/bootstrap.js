...
let courtSortKey='lastBookingDate',courtSortDir='desc',stuSortKey='lastLesson',stuSortDir='desc',leadSortKey='',leadSortDir='',courtOwnerFilterValue='',courtAccountTypeFilterValue='',courtCampusFilterValue='',courtDateRangeFilterValue=globalDateRangeFilterValue,courtDateRangeStart=globalDateRangeStart,courtDateRangeEnd=globalDateRangeEnd,leadPageSize=15,stuPageSize=15,schPageSize=15,courtPageSize=15,purPageSize=15,pkgPageSize=15,pricePageSize=15,financeLedgerPageSize=15,financeRevenuePageSize=15,financeRecognizedPageSize=15,adminUserPageSize=15,selectedCourtIds=new Set(),courtBatchMode=false;

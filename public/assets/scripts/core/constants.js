const API='';
let CAMPUS={};
const CAMPUS_RULES=(typeof FlowTennisCampus==='object'&&FlowTennisCampus)||{};
function campusDisplayName(value){
  return typeof CAMPUS_RULES.displayCampusName==='function'?CAMPUS_RULES.displayCampusName(value):String(value??'').trim();
}
function campusKey(value){
  return typeof CAMPUS_RULES.normalizeCampusValue==='function'?CAMPUS_RULES.normalizeCampusValue(value):String(value??'').trim();
}
